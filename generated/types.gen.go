...
// Defines values for DynamicInterpretation.
const (
	INTERPRETATIONMULTIVALUEKPI     DynamicInterpretation = "INTERPRETATION_MULTI_VALUE_KPI"
	INTERPRETATIONRAWDATATABLE      DynamicInterpretation = "INTERPRETATION_RAW_DATA_TABLE"
	INTERPRETATIONSINGLEVALUEKPI    DynamicInterpretation = "INTERPRETATION_SINGLE_VALUE_KPI"
	INTERPRETATIONTRENDOVERTIMELINE DynamicInterpretation = "INTERPRETATION_TREND_OVER_TIME_LINE"
	INTERPRETATIONUNSPECIFIED       DynamicInterpretation = "INTERPRETATION_UNSPECIFIED"
)
...
// Defines values for CommonActionDataSourceType.
const (
	ACTIONDATASOURCETYPEDATAPRIME       CommonActionDataSourceType = "ACTION_DATA_SOURCE_TYPE_DATAPRIME"
	ACTIONDATASOURCETYPELOGS            CommonActionDataSourceType = "ACTION_DATA_SOURCE_TYPE_LOGS"
	ACTIONDATASOURCETYPEMETRICS         CommonActionDataSourceType = "ACTION_DATA_SOURCE_TYPE_METRICS"
	ACTIONDATASOURCETYPENONEUNSPECIFIED CommonActionDataSourceType = "ACTION_DATA_SOURCE_TYPE_NONE_UNSPECIFIED"
	ACTIONDATASOURCETYPESPANS           CommonActionDataSourceType = "ACTION_DATA_SOURCE_TYPE_SPANS"
)
...
// Defines values for Coralogixapiseventsv3FilterMatcher.
const (
	FILTERMATCHERREGEXP            Coralogixapiseventsv3FilterMatcher = "FILTER_MATCHER_REGEXP"
	FILTERMATCHERTEXTORUNSPECIFIED Coralogixapiseventsv3FilterMatcher = "FILTER_MATCHER_TEXT_OR_UNSPECIFIED"
)
...
// Defines values for Scopesv1EntityType.
const (
	Scopesv1EntityTypeENTITYTYPELOGS        Scopesv1EntityType = "ENTITY_TYPE_LOGS"
	Scopesv1EntityTypeENTITYTYPESPANS       Scopesv1EntityType = "ENTITY_TYPE_SPANS"
	Scopesv1EntityTypeENTITYTYPEUNSPECIFIED Scopesv1EntityType = "ENTITY_TYPE_UNSPECIFIED"
)
...
// Defines values for V1DurationFrequency.
const (
	DURATIONFREQUENCYDAY         V1DurationFrequency = "DURATION_FREQUENCY_DAY"
	DURATIONFREQUENCYHOUR        V1DurationFrequency = "DURATION_FREQUENCY_HOUR"
	DURATIONFREQUENCYMINUTE      V1DurationFrequency = "DURATION_FREQUENCY_MINUTE"
	DURATIONFREQUENCYUNSPECIFIED V1DurationFrequency = "DURATION_FREQUENCY_UNSPECIFIED"
)
...
// Defines values for V1RouterEvaluationMode.
const (
	EVALUATEALL                     V1RouterEvaluationMode = "EVALUATE_ALL"
	ROUTEREVALUATIONMODEUNSPECIFIED V1RouterEvaluationMode = "ROUTER_EVALUATION_MODE_UNSPECIFIED"
	STOPONFIRSTMATCH                V1RouterEvaluationMode = "STOP_ON_FIRST_MATCH"
)
...
// Defines values for V1ScheduleOperation.
const (
	SCHEDULEOPERATIONACTIVATE    V1ScheduleOperation = "SCHEDULE_OPERATION_ACTIVATE"
	SCHEDULEOPERATIONMUTE        V1ScheduleOperation = "SCHEDULE_OPERATION_MUTE"
	SCHEDULEOPERATIONUNSPECIFIED V1ScheduleOperation = "SCHEDULE_OPERATION_UNSPECIFIED"
)
...
const (
	V3AlertDefPriorityALERTDEFPRIORITYP1              V3AlertDefPriority = "ALERT_DEF_PRIORITY_P1"
	V3AlertDefPriorityALERTDEFPRIORITYP2              V3AlertDefPriority = "ALERT_DEF_PRIORITY_P2"
	V3AlertDefPriorityALERTDEFPRIORITYP3              V3AlertDefPriority = "ALERT_DEF_PRIORITY_P3"
	V3AlertDefPriorityALERTDEFPRIORITYP4              V3AlertDefPriority = "ALERT_DEF_PRIORITY_P4"
	V3AlertDefPriorityALERTDEFPRIORITYP5ORUNSPECIFIED V3AlertDefPriority = "ALERT_DEF_PRIORITY_P5_OR_UNSPECIFIED"
)

// Defines values for V3AlertDefType.
const (
	V3AlertDefTypeALERTDEFTYPEFLOW                       V3AlertDefType = "ALERT_DEF_TYPE_FLOW"
	V3AlertDefTypeALERTDEFTYPELOGSANOMALY                V3AlertDefType = "ALERT_DEF_TYPE_LOGS_ANOMALY"
	V3AlertDefTypeALERTDEFTYPELOGSIMMEDIATEORUNSPECIFIED V3AlertDefType = "ALERT_DEF_TYPE_LOGS_IMMEDIATE_OR_UNSPECIFIED"
	V3AlertDefTypeALERTDEFTYPELOGSNEWVALUE               V3AlertDefType = "ALERT_DEF_TYPE_LOGS_NEW_VALUE"
	V3AlertDefTypeALERTDEFTYPELOGSRATIOTHRESHOLD         V3AlertDefType = "ALERT_DEF_TYPE_LOGS_RATIO_THRESHOLD"
	V3AlertDefTypeALERTDEFTYPELOGSTHRESHOLD              V3AlertDefType = "ALERT_DEF_TYPE_LOGS_THRESHOLD"
	V3AlertDefTypeALERTDEFTYPELOGSTIMERELATIVETHRESHOLD  V3AlertDefType = "ALERT_DEF_TYPE_LOGS_TIME_RELATIVE_THRESHOLD"
	V3AlertDefTypeALERTDEFTYPELOGSUNIQUECOUNT            V3AlertDefType = "ALERT_DEF_TYPE_LOGS_UNIQUE_COUNT"
	V3AlertDefTypeALERTDEFTYPEMETRICANOMALY              V3AlertDefType = "ALERT_DEF_TYPE_METRIC_ANOMALY"
	V3AlertDefTypeALERTDEFTYPEMETRICTHRESHOLD            V3AlertDefType = "ALERT_DEF_TYPE_METRIC_THRESHOLD"
	V3AlertDefTypeALERTDEFTYPESLOTHRESHOLD               V3AlertDefType = "ALERT_DEF_TYPE_SLO_THRESHOLD"
	V3AlertDefTypeALERTDEFTYPETRACINGIMMEDIATE           V3AlertDefType = "ALERT_DEF_TYPE_TRACING_IMMEDIATE"
	V3AlertDefTypeALERTDEFTYPETRACINGTHRESHOLD           V3AlertDefType = "ALERT_DEF_TYPE_TRACING_THRESHOLD"
)
...
// Defines values for VariablesMultiSelectRefreshStrategy.
const (
	VariablesMultiSelectRefreshStrategyREFRESHSTRATEGYONDASHBOARDLOAD   VariablesMultiSelectRefreshStrategy = "REFRESH_STRATEGY_ON_DASHBOARD_LOAD"
	VariablesMultiSelectRefreshStrategyREFRESHSTRATEGYONTIMEFRAMECHANGE VariablesMultiSelectRefreshStrategy = "REFRESH_STRATEGY_ON_TIME_FRAME_CHANGE"
	VariablesMultiSelectRefreshStrategyREFRESHSTRATEGYUNSPECIFIED       VariablesMultiSelectRefreshStrategy = "REFRESH_STRATEGY_UNSPECIFIED"
)

// Defines values for VariablesVariableDisplayType.
const (
	VARIABLEDISPLAYTYPELABELVALUE  VariablesVariableDisplayType = "VARIABLE_DISPLAY_TYPE_LABEL_VALUE"
	VARIABLEDISPLAYTYPENOTHING     VariablesVariableDisplayType = "VARIABLE_DISPLAY_TYPE_NOTHING"
	VARIABLEDISPLAYTYPEUNSPECIFIED VariablesVariableDisplayType = "VARIABLE_DISPLAY_TYPE_UNSPECIFIED"
	VARIABLEDISPLAYTYPEVALUE       VariablesVariableDisplayType = "VARIABLE_DISPLAY_TYPE_VALUE"
)

// Defines values for VariablesV2VariableDisplayTypeV2.
const (
	VARIABLEDISPLAYTYPEV2LABELVALUE  VariablesV2VariableDisplayTypeV2 = "VARIABLE_DISPLAY_TYPE_V2_LABEL_VALUE"
	VARIABLEDISPLAYTYPEV2NOTHING     VariablesV2VariableDisplayTypeV2 = "VARIABLE_DISPLAY_TYPE_V2_NOTHING"
	VARIABLEDISPLAYTYPEV2UNSPECIFIED VariablesV2VariableDisplayTypeV2 = "VARIABLE_DISPLAY_TYPE_V2_UNSPECIFIED"
	VARIABLEDISPLAYTYPEV2VALUE       VariablesV2VariableDisplayTypeV2 = "VARIABLE_DISPLAY_TYPE_V2_VALUE"
)

// Defines values for VariablesV2VariableSourceV2RefreshStrategy.
const (
	VariablesV2VariableSourceV2RefreshStrategyREFRESHSTRATEGYONDASHBOARDLOAD   VariablesV2VariableSourceV2RefreshStrategy = "REFRESH_STRATEGY_ON_DASHBOARD_LOAD"
	VariablesV2VariableSourceV2RefreshStrategyREFRESHSTRATEGYONTIMEFRAMECHANGE VariablesV2VariableSourceV2RefreshStrategy = "REFRESH_STRATEGY_ON_TIME_FRAME_CHANGE"
	VariablesV2VariableSourceV2RefreshStrategyREFRESHSTRATEGYUNSPECIFIED       VariablesV2VariableSourceV2RefreshStrategy = "REFRESH_STRATEGY_UNSPECIFIED"
)
...
const (
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeAWSEVENTBRIDGE        OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "AWS_EVENT_BRIDGE"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeDEMISTO               OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "DEMISTO"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeEMAILGROUP            OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "EMAIL_GROUP"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeGENERIC               OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "GENERIC"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeIBMEVENTNOTIFICATIONS OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "IBM_EVENT_NOTIFICATIONS"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeJIRA                  OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "JIRA"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeMICROSOFTTEAMS        OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "MICROSOFT_TEAMS"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeMSTEAMSWORKFLOW       OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "MS_TEAMS_WORKFLOW"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeOPSGENIE              OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "OPSGENIE"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypePAGERDUTY             OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "PAGERDUTY"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeSENDLOG               OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "SEND_LOG"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeSLACK                 OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "SLACK"
	OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsTypeUNKNOWN               OutgoingWebhooksServiceGetOutgoingWebhookTypeDetailsParamsType = "UNKNOWN"
)

// Defines values for OutgoingWebhooksServiceListOutgoingWebhooksParamsType.
const (
	AWSEVENTBRIDGE        OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "AWS_EVENT_BRIDGE"
	DEMISTO               OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "DEMISTO"
	EMAILGROUP            OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "EMAIL_GROUP"
	GENERIC               OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "GENERIC"
	IBMEVENTNOTIFICATIONS OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "IBM_EVENT_NOTIFICATIONS"
	JIRA                  OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "JIRA"
	MICROSOFTTEAMS        OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "MICROSOFT_TEAMS"
	MSTEAMSWORKFLOW       OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "MS_TEAMS_WORKFLOW"
	OPSGENIE              OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "OPSGENIE"
	PAGERDUTY             OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "PAGERDUTY"
	SENDLOG               OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "SEND_LOG"
	SLACK                 OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "SLACK"
	UNKNOWN               OutgoingWebhooksServiceListOutgoingWebhooksParamsType = "UNKNOWN"
)
...
// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcherFILTERMATCHERCONTAINS    AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher = "FILTER_MATCHER_CONTAINS"
	AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcherFILTERMATCHEREQUALS      AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher = "FILTER_MATCHER_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcherFILTERMATCHERNOTEQUALS   AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher = "FILTER_MATCHER_NOT_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcherFILTERMATCHERUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher = "FILTER_MATCHER_UNSPECIFIED"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPEFLOW                       AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_FLOW"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSANOMALY                AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_ANOMALY"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSIMMEDIATEORUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_IMMEDIATE_OR_UNSPECIFIED"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSNEWVALUE               AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_NEW_VALUE"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSRATIOTHRESHOLD         AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_RATIO_THRESHOLD"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSTHRESHOLD              AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_THRESHOLD"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSTIMERELATIVETHRESHOLD  AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_TIME_RELATIVE_THRESHOLD"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPELOGSUNIQUECOUNT            AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_LOGS_UNIQUE_COUNT"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPEMETRICANOMALY              AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_METRIC_ANOMALY"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPEMETRICTHRESHOLD            AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_METRIC_THRESHOLD"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPESLOTHRESHOLD               AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_SLO_THRESHOLD"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPETRACINGIMMEDIATE           AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_TRACING_IMMEDIATE"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterTypeALERTDEFTYPETRACINGTHRESHOLD           AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType = "ALERT_DEF_TYPE_TRACING_THRESHOLD"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcherFILTERMATCHERCONTAINS    AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher = "FILTER_MATCHER_CONTAINS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcherFILTERMATCHEREQUALS      AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher = "FILTER_MATCHER_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcherFILTERMATCHERNOTEQUALS   AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher = "FILTER_MATCHER_NOT_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcherFILTERMATCHERUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher = "FILTER_MATCHER_UNSPECIFIED"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator.
const (
	FILTERVALUESOPERATORAND         AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator = "FILTER_VALUES_OPERATOR_AND"
	FILTERVALUESOPERATOROR          AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator = "FILTER_VALUES_OPERATOR_OR"
	FILTERVALUESOPERATORUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator = "FILTER_VALUES_OPERATOR_UNSPECIFIED"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriorityALERTDEFPRIORITYP1              AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority = "ALERT_DEF_PRIORITY_P1"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriorityALERTDEFPRIORITYP2              AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority = "ALERT_DEF_PRIORITY_P2"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriorityALERTDEFPRIORITYP3              AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority = "ALERT_DEF_PRIORITY_P3"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriorityALERTDEFPRIORITYP4              AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority = "ALERT_DEF_PRIORITY_P4"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriorityALERTDEFPRIORITYP5ORUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority = "ALERT_DEF_PRIORITY_P5_OR_UNSPECIFIED"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcherFILTERMATCHERCONTAINS    AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher = "FILTER_MATCHER_CONTAINS"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcherFILTERMATCHEREQUALS      AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher = "FILTER_MATCHER_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcherFILTERMATCHERNOTEQUALS   AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher = "FILTER_MATCHER_NOT_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcherFILTERMATCHERUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher = "FILTER_MATCHER_UNSPECIFIED"
)

// Defines values for AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher.
const (
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcherFILTERMATCHERCONTAINS    AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher = "FILTER_MATCHER_CONTAINS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcherFILTERMATCHEREQUALS      AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher = "FILTER_MATCHER_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcherFILTERMATCHERNOTEQUALS   AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher = "FILTER_MATCHER_NOT_EQUALS"
	AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcherFILTERMATCHERUNSPECIFIED AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher = "FILTER_MATCHER_UNSPECIFIED"
)
...
// ActionDefinitionCustomAction defines model for ActionDefinitionCustomAction.
type ActionDefinitionCustomAction struct {
	// Url Static URL that may contain variables using {{variable_name}} syntax
	Url *string `json:"url,omitempty"`
}

// ActionDefinitionGoToDashboardTemplateAction defines model for ActionDefinitionGoToDashboardTemplateAction.
type ActionDefinitionGoToDashboardTemplateAction struct {
	// DashboardId Reference to specific dashboard
...
// DynamicInterpretation defines model for DynamicInterpretation.
type DynamicInterpretation string
...
type FilterMetricsFilter struct {
	...
	Operator *FiltersFilterOperator `json:"operator,omitempty"`
}
...
type IntegrationRevisionFieldInformation struct {
	...
	SingleNumber           *V1IntegrationRevisionSingleNumericValue   `json:"singleNumber,omitempty"`
...
type LineChartQueryDefinition struct {
	...
	// DecimalPrecision Whether to render numeric value without abbreviation
...
type MultiSelectQueryLogsQuery struct {
	Type *MultiSelectQueryLogsQueryType `json:"type,omitempty"`
}

// MultiSelectQueryLogsQueryType defines model for MultiSelectQueryLogsQueryType.
type MultiSelectQueryLogsQueryType struct {
	FieldName  *MultiSelectQueryLogsQueryTypeFieldName  `json:"fieldName,omitempty"`
	FieldValue *MultiSelectQueryLogsQueryTypeFieldValue `json:"fieldValue,omitempty"`
}

// MultiSelectQueryLogsQueryTypeFieldName defines model for MultiSelectQueryLogsQueryTypeFieldName.
type MultiSelectQueryLogsQueryTypeFieldName struct {
	LogRegex *string `json:"logRegex,omitempty"`
}

// MultiSelectQueryLogsQueryTypeFieldValue defines model for MultiSelectQueryLogsQueryTypeFieldValue.
type MultiSelectQueryLogsQueryTypeFieldValue struct {
	ObservationField *CommonObservationField `json:"observationField,omitempty"`
}

// MultiSelectQueryMetricsQuery defines model for MultiSelectQueryMetricsQuery.
type MultiSelectQueryMetricsQuery struct {
	Type *MultiSelectQueryMetricsQueryType `json:"type,omitempty"`
}

// MultiSelectQueryMetricsQueryEquals defines model for MultiSelectQueryMetricsQueryEquals.
type MultiSelectQueryMetricsQueryEquals struct {
	Selection *MultiSelectQueryMetricsQuerySelection `json:"selection,omitempty"`
}

// MultiSelectQueryMetricsQueryMetricsLabelFilter defines model for MultiSelectQueryMetricsQueryMetricsLabelFilter.
type MultiSelectQueryMetricsQueryMetricsLabelFilter struct {
	Label    *MultiSelectQueryMetricsQueryStringOrVariable `json:"label,omitempty"`
	Metric   *MultiSelectQueryMetricsQueryStringOrVariable `json:"metric,omitempty"`
	Operator *MultiSelectQueryMetricsQueryOperator         `json:"operator,omitempty"`
}

// MultiSelectQueryMetricsQueryNotEquals defines model for MultiSelectQueryMetricsQueryNotEquals.
type MultiSelectQueryMetricsQueryNotEquals struct {
	Selection *MultiSelectQueryMetricsQuerySelection `json:"selection,omitempty"`
}

// MultiSelectQueryMetricsQueryOperator defines model for MultiSelectQueryMetricsQueryOperator.
type MultiSelectQueryMetricsQueryOperator struct {
	Equals    *MultiSelectQueryMetricsQueryEquals    `json:"equals,omitempty"`
	NotEquals *MultiSelectQueryMetricsQueryNotEquals `json:"notEquals,omitempty"`
}

// MultiSelectQueryMetricsQuerySelection defines model for MultiSelectQueryMetricsQuerySelection.
type MultiSelectQueryMetricsQuerySelection struct {
	List *MultiSelectQueryMetricsQuerySelectionListSelection `json:"list,omitempty"`
}

// MultiSelectQueryMetricsQuerySelectionListSelection defines model for MultiSelectQueryMetricsQuerySelectionListSelection.
type MultiSelectQueryMetricsQuerySelectionListSelection struct {
	Values *[]MultiSelectQueryMetricsQueryStringOrVariable `json:"values,omitempty"`
}

// MultiSelectQueryMetricsQueryStringOrVariable defines model for MultiSelectQueryMetricsQueryStringOrVariable.
type MultiSelectQueryMetricsQueryStringOrVariable struct {
	StringValue  *string `json:"stringValue,omitempty"`
	VariableName *string `json:"variableName,omitempty"`
}

// MultiSelectQueryMetricsQueryType defines model for MultiSelectQueryMetricsQueryType.
type MultiSelectQueryMetricsQueryType struct {
	LabelName  *MultiSelectQueryMetricsQueryTypeLabelName  `json:"labelName,omitempty"`
	LabelValue *MultiSelectQueryMetricsQueryTypeLabelValue `json:"labelValue,omitempty"`
	MetricName *MultiSelectQueryMetricsQueryTypeMetricName `json:"metricName,omitempty"`
}

// MultiSelectQueryMetricsQueryTypeLabelName defines model for MultiSelectQueryMetricsQueryTypeLabelName.
type MultiSelectQueryMetricsQueryTypeLabelName struct {
	MetricRegex *string `json:"metricRegex,omitempty"`
}

// MultiSelectQueryMetricsQueryTypeLabelValue defines model for MultiSelectQueryMetricsQueryTypeLabelValue.
type MultiSelectQueryMetricsQueryTypeLabelValue struct {
	LabelFilters *[]MultiSelectQueryMetricsQueryMetricsLabelFilter `json:"labelFilters,omitempty"`
	LabelName    *MultiSelectQueryMetricsQueryStringOrVariable     `json:"labelName,omitempty"`
	MetricName   *MultiSelectQueryMetricsQueryStringOrVariable     `json:"metricName,omitempty"`
}

// MultiSelectQueryMetricsQueryTypeMetricName defines model for MultiSelectQueryMetricsQueryTypeMetricName.
type MultiSelectQueryMetricsQueryTypeMetricName struct {
	MetricRegex *string `json:"metricRegex,omitempty"`
}

// MultiSelectQuerySpansQuery defines model for MultiSelectQuerySpansQuery.
type MultiSelectQuerySpansQuery struct {
	Type *MultiSelectQuerySpansQueryType `json:"type,omitempty"`
}

// MultiSelectQuerySpansQueryType defines model for MultiSelectQuerySpansQueryType.
type MultiSelectQuerySpansQueryType struct {
	FieldName  *MultiSelectQuerySpansQueryTypeFieldName  `json:"fieldName,omitempty"`
	FieldValue *MultiSelectQuerySpansQueryTypeFieldValue `json:"fieldValue,omitempty"`
}

// MultiSelectQuerySpansQueryTypeFieldName defines model for MultiSelectQuerySpansQueryTypeFieldName.
type MultiSelectQuerySpansQueryTypeFieldName struct {
	SpanRegex *string `json:"spanRegex,omitempty"`
}

// MultiSelectQuerySpansQueryTypeFieldValue defines model for MultiSelectQuerySpansQueryTypeFieldValue.
type MultiSelectQuerySpansQueryTypeFieldValue struct {
	ObservationField *CommonObservationField `json:"observationField,omitempty"`
...
// MultiStringValueAllValue defines model for MultiStringValueAllValue.
type MultiStringValueAllValue = map[string]interface{}
...
type QueryLogs struct {
	...
	Filters *[]FiltersFilterLogsFilter `json:"filters,omitempty"`
...
// QueryMetrics A metrics variant of the query
...
// QuerySpans A spans variant of the query
type QuerySpans struct {
	// Aggregation Span query aggregation function
	Aggregation  *[]CommonSpansAggregation `json:"aggregation,omitempty"`
	DataModeType *CommonDataModeType       `json:"dataModeType,omitempty"`
	...
	// GroupBy A list of fields to group the records by
	GroupBy     *[]CommonSpanObservationField `json:"groupBy,omitempty"`
	LuceneQuery *AstwidgetscommonLuceneQuery  `json:"luceneQuery,omitempty"`
}

// RecurringAlways defines model for RecurringAlways.
type RecurringAlways = map[string]interface{}
...
// StaticSourceValueLabel defines model for StaticSourceValueLabel.
type StaticSourceValueLabel struct {
...
// TextBoxSourceTextBoxDefaultValue defines model for TextBoxSourceTextBoxDefaultValue.
type TextBoxSourceTextBoxDefaultValue struct {
...
// VariableSourceV2AllOption defines model for VariableSourceV2AllOption.
type VariableSourceV2AllOption struct {
	IncludeAll *bool   `json:"includeAll,omitempty"`
	Label      *string `json:"label,omitempty"`
}

// VariableSourceV2QuerySourceLogsQuery defines model for VariableSourceV2QuerySourceLogsQuery.
type VariableSourceV2QuerySourceLogsQuery struct {
	Type *VariableSourceV2QuerySourceLogsQueryType `json:"type,omitempty"`
}

// VariableSourceV2QuerySourceLogsQueryType defines model for VariableSourceV2QuerySourceLogsQueryType.
type VariableSourceV2QuerySourceLogsQueryType struct {
	FieldName  *VariableSourceV2QuerySourceLogsQueryTypeFieldName  `json:"fieldName,omitempty"`
	FieldValue *VariableSourceV2QuerySourceLogsQueryTypeFieldValue `json:"fieldValue,omitempty"`
}

// VariableSourceV2QuerySourceLogsQueryTypeFieldName defines model for VariableSourceV2QuerySourceLogsQueryTypeFieldName.
type VariableSourceV2QuerySourceLogsQueryTypeFieldName struct {
	LogRegex *string `json:"logRegex,omitempty"`
}

// VariableSourceV2QuerySourceLogsQueryTypeFieldValue defines model for VariableSourceV2QuerySourceLogsQueryTypeFieldValue.
type VariableSourceV2QuerySourceLogsQueryTypeFieldValue struct {
	ObservationField *CommonObservationField `json:"observationField,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQuery defines model for VariableSourceV2QuerySourceMetricsQuery.
type VariableSourceV2QuerySourceMetricsQuery struct {
	Type *VariableSourceV2QuerySourceMetricsQueryType `json:"type,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryEquals defines model for VariableSourceV2QuerySourceMetricsQueryEquals.
type VariableSourceV2QuerySourceMetricsQueryEquals struct {
	Selection *VariableSourceV2QuerySourceMetricsQuerySelection `json:"selection,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryMetricsLabelFilter defines model for VariableSourceV2QuerySourceMetricsQueryMetricsLabelFilter.
type VariableSourceV2QuerySourceMetricsQueryMetricsLabelFilter struct {
	Label    *VariableSourceV2QuerySourceMetricsQueryStringOrVariable `json:"label,omitempty"`
	Metric   *VariableSourceV2QuerySourceMetricsQueryStringOrVariable `json:"metric,omitempty"`
	Operator *VariableSourceV2QuerySourceMetricsQueryOperator         `json:"operator,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryNotEquals defines model for VariableSourceV2QuerySourceMetricsQueryNotEquals.
type VariableSourceV2QuerySourceMetricsQueryNotEquals struct {
	Selection *VariableSourceV2QuerySourceMetricsQuerySelection `json:"selection,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryOperator defines model for VariableSourceV2QuerySourceMetricsQueryOperator.
type VariableSourceV2QuerySourceMetricsQueryOperator struct {
	Equals    *VariableSourceV2QuerySourceMetricsQueryEquals    `json:"equals,omitempty"`
	NotEquals *VariableSourceV2QuerySourceMetricsQueryNotEquals `json:"notEquals,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQuerySelection defines model for VariableSourceV2QuerySourceMetricsQuerySelection.
type VariableSourceV2QuerySourceMetricsQuerySelection struct {
	List *VariableSourceV2QuerySourceMetricsQuerySelectionListSelection `json:"list,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQuerySelectionListSelection defines model for VariableSourceV2QuerySourceMetricsQuerySelectionListSelection.
type VariableSourceV2QuerySourceMetricsQuerySelectionListSelection struct {
	Values *[]VariableSourceV2QuerySourceMetricsQueryStringOrVariable `json:"values,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryStringOrVariable defines model for VariableSourceV2QuerySourceMetricsQueryStringOrVariable.
type VariableSourceV2QuerySourceMetricsQueryStringOrVariable struct {
	StringValue  *string `json:"stringValue,omitempty"`
	VariableName *string `json:"variableName,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryType defines model for VariableSourceV2QuerySourceMetricsQueryType.
type VariableSourceV2QuerySourceMetricsQueryType struct {
	LabelName  *VariableSourceV2QuerySourceMetricsQueryTypeLabelName  `json:"labelName,omitempty"`
	LabelValue *VariableSourceV2QuerySourceMetricsQueryTypeLabelValue `json:"labelValue,omitempty"`
	MetricName *VariableSourceV2QuerySourceMetricsQueryTypeMetricName `json:"metricName,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryTypeLabelName defines model for VariableSourceV2QuerySourceMetricsQueryTypeLabelName.
type VariableSourceV2QuerySourceMetricsQueryTypeLabelName struct {
	MetricRegex *string `json:"metricRegex,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryTypeLabelValue defines model for VariableSourceV2QuerySourceMetricsQueryTypeLabelValue.
type VariableSourceV2QuerySourceMetricsQueryTypeLabelValue struct {
	LabelFilters *[]VariableSourceV2QuerySourceMetricsQueryMetricsLabelFilter `json:"labelFilters,omitempty"`
	LabelName    *VariableSourceV2QuerySourceMetricsQueryStringOrVariable     `json:"labelName,omitempty"`
	MetricName   *VariableSourceV2QuerySourceMetricsQueryStringOrVariable     `json:"metricName,omitempty"`
}

// VariableSourceV2QuerySourceMetricsQueryTypeMetricName defines model for VariableSourceV2QuerySourceMetricsQueryTypeMetricName.
type VariableSourceV2QuerySourceMetricsQueryTypeMetricName struct {
	MetricRegex *string `json:"metricRegex,omitempty"`
}

// VariableSourceV2QuerySourceSpansQuery defines model for VariableSourceV2QuerySourceSpansQuery.
type VariableSourceV2QuerySourceSpansQuery struct {
	Type *VariableSourceV2QuerySourceSpansQueryType `json:"type,omitempty"`
}

// VariableSourceV2QuerySourceSpansQueryType defines model for VariableSourceV2QuerySourceSpansQueryType.
type VariableSourceV2QuerySourceSpansQueryType struct {
	FieldName  *VariableSourceV2QuerySourceSpansQueryTypeFieldName  `json:"fieldName,omitempty"`
	FieldValue *VariableSourceV2QuerySourceSpansQueryTypeFieldValue `json:"fieldValue,omitempty"`
}

// VariableSourceV2QuerySourceSpansQueryTypeFieldName defines model for VariableSourceV2QuerySourceSpansQueryTypeFieldName.
type VariableSourceV2QuerySourceSpansQueryTypeFieldName struct {
	SpanRegex *string `json:"spanRegex,omitempty"`
}

// VariableSourceV2QuerySourceSpansQueryTypeFieldValue defines model for VariableSourceV2QuerySourceSpansQueryTypeFieldValue.
type VariableSourceV2QuerySourceSpansQueryTypeFieldValue struct {
	ObservationField *CommonObservationField `json:"observationField,omitempty"`
	Value            *CommonSpanField        `json:"value,omitempty"`
}

// VariableSourceV2StaticSource defines model for VariableSourceV2StaticSource.
type VariableSourceV2StaticSource struct {
	AllOption            *VariableSourceV2AllOption `json:"allOption,omitempty"`
	Values               *[]StaticSourceValueLabel  `json:"values,omitempty"`
	ValuesOrderDirection *CommonOrderDirection      `json:"valuesOrderDirection,omitempty"`
}

// VariableSourceV2TextBoxSource defines model for VariableSourceV2TextBoxSource.
type VariableSourceV2TextBoxSource struct {
	DefaultValue *TextBoxSourceTextBoxDefaultValue `json:"defaultValue,omitempty"`
}

// VariableValueV2LuceneQueryValue defines model for VariableValueV2LuceneQueryValue.
type VariableValueV2LuceneQueryValue struct {
	Label *string `json:"label,omitempty"`
	Value *string `json:"value,omitempty"`
}

// VariableValueV2MultiStringValue defines model for VariableValueV2MultiStringValue.
type VariableValueV2MultiStringValue struct {
	All  *MultiStringValueAllValue                 `json:"all,omitempty"`
	List *VariableValueV2MultiStringValueListValue `json:"list,omitempty"`
}

// VariableValueV2MultiStringValueListValue defines model for VariableValueV2MultiStringValueListValue.
type VariableValueV2MultiStringValueListValue struct {
	Values *[]VariableValueV2SingleStringValue `json:"values,omitempty"`
}

// VariableValueV2RegexValue defines model for VariableValueV2RegexValue.
type VariableValueV2RegexValue struct {
	Label *string `json:"label,omitempty"`
	Value *string `json:"value,omitempty"`
}

// VariableValueV2SingleStringValue defines model for VariableValueV2SingleStringValue.
type VariableValueV2SingleStringValue struct {
	Label *string `json:"label,omitempty"`
	Value *string `json:"value,omitempty"`
}
...
// AlertSchedulerRuleProtobufv1Duration defines model for alert_scheduler_rule_protobufv1Duration.
type AlertSchedulerRuleProtobufv1Duration struct {
	// ForOver Duration for_over: The duration interval.
	ForOver   *int32               `json:"forOver,omitempty"`
	Frequency *V1DurationFrequency `json:"frequency,omitempty"`
}

// AlertingalertSchedulerRuleProtobufv1Filter defines model for alertingalert_scheduler_rule_protobufv1Filter.
type AlertingalertSchedulerRuleProtobufv1Filter struct {
	AlertMetaLabels *V1MetaLabels     `json:"alertMetaLabels,omitempty"`
	AlertUniqueIds  *V1AlertUniqueIds `json:"alertUniqueIds,omitempty"`

	// WhatExpression Filter what_expression: dataprime expression that filter the alerts group by values.
	WhatExpression *string `json:"whatExpression,omitempty"`
}

// AlertingmetaLabelsProtobufv1MetaLabel defines model for alertingmeta_labels_protobufv1MetaLabel.
type AlertingmetaLabelsProtobufv1MetaLabel struct {
	Id    *string `json:"id,omitempty"`
	Key   *string `json:"key,omitempty"`
	Value *string `json:"value,omitempty"`
}
...
type Alertsv3SourceOverrides struct {
	...
	// PayloadType the payload type for the notification
...
// AnnotationsAnnotationSource defines model for annotationsAnnotationSource.
type AnnotationsAnnotationSource struct {
...
type AstDashboard struct {
	...
	// Actions A list of public actions that are available within the dashboard context
	Actions *[]CommonDashboardAction `json:"actions,omitempty"`

	// Annotations A list of annotations that can be used within the dashboard's visualizations
	Annotations *[]AstannotationsAnnotation `json:"annotations,omitempty"`
	...
	Filters     *[]AstfiltersFilter              `json:"filters,omitempty"`
	...
	// SlugName A unique slug name serving as an alias for accessing the dashboard
	...
	Variables *[]VariablesVariable `json:"variables,omitempty"`

	// VariablesV2 A list of variables that can be used within the dashboard for dynamic content
	VariablesV2 *[]VariablesV2VariableV2 `json:"variablesV2,omitempty"`
}
...
type AstWidgetDefinition struct {
	...
	Dynamic            *AstwidgetsDynamic         `json:"dynamic,omitempty"`
...
// AstannotationsAnnotation defines model for astannotationsAnnotation.
type AstannotationsAnnotation struct {
	Enabled *bool                        `json:"enabled,omitempty"`
	Id      *string                      `json:"id,omitempty"`
	Name    *string                      `json:"name,omitempty"`
	Source  *AnnotationsAnnotationSource `json:"source,omitempty"`
}

// AstfiltersFilter This data structure represents the configuration for filtering data on the dashboard.
type AstfiltersFilter struct {
	...
	Source *FiltersFilterSource `json:"source,omitempty"`
}

// AstwidgetsDynamic defines model for astwidgetsDynamic.
type AstwidgetsDynamic struct {
	Interpretation *DynamicInterpretation `json:"interpretation,omitempty"`
	Query          *WidgetsDynamicQuery   `json:"query,omitempty"`
...
// CommonActionDataSourceType defines model for commonActionDataSourceType.
type CommonActionDataSourceType string

// CommonActionDefinition defines model for commonActionDefinition.
type CommonActionDefinition struct {
	CustomAction        *ActionDefinitionCustomAction                `json:"customAction,omitempty"`
	GoToDashboardAction *ActionDefinitionGoToDashboardTemplateAction `json:"goToDashboardAction,omitempty"`
}
...
// CommonDashboardAction Public actions that are always available within specific dashboard's context.
type CommonDashboardAction struct {
	DataSource *CommonActionDataSourceType `json:"dataSource,omitempty"`
	Definition *CommonActionDefinition     `json:"definition,omitempty"`

	// Id A unique identifier of the action
	Id *string `json:"id,omitempty"`

	// Name The display name of the action
	Name *string `json:"name,omitempty"`

	// ShouldOpenInNewWindow Defines if the action should open in a new window or current window in the browser
	ShouldOpenInNewWindow *bool `json:"shouldOpenInNewWindow,omitempty"`

	// WidgetId Reference to specific widget within a dashboard, can be null if the action is dashboard wide
...
// Coralogixapiseventsv3FilterMatcher defines model for coralogixapiseventsv3FilterMatcher.
type Coralogixapiseventsv3FilterMatcher string
...
type Coralogixapisscopesv1Filter struct {
	EntityType *Scopesv1EntityType `json:"entityType,omitempty"`
...
// FiltersFilterEquals This data structure represents an equality comparison operation.
type FiltersFilterEquals struct {
...
// FiltersFilterLogsFilter This data structure represents the filter criteria for logs.
type FiltersFilterLogsFilter struct {
...
// FiltersFilterNotEquals This data structure represents a non-equality comparison operation.
type FiltersFilterNotEquals struct {
...
// FiltersFilterOperator This data structure defines the comparison operation for the filter.
type FiltersFilterOperator struct {
	// Equals This data structure represents an equality comparison operation.
	Equals *FiltersFilterEquals `json:"equals,omitempty"`

	// NotEquals This data structure represents a non-equality comparison operation.
	NotEquals *FiltersFilterNotEquals `json:"notEquals,omitempty"`
}

// FiltersFilterSource Defines the type of data the filter applies to.
type FiltersFilterSource struct {
	// Logs This data structure represents the filter criteria for logs.
	Logs *FiltersFilterLogsFilter `json:"logs,omitempty"`
...
type NotificationCenterMatchEntityTypeCondition = map[string]interface{}
...
// Scopesv1EntityType defines model for scopesv1EntityType.
type Scopesv1EntityType string
...
type ServicesCreateDashboardFolderResponse struct {
	FolderId *string `json:"folderId,omitempty"`
}
...
// ServicesGetDashboardBySlugResponse This is a response containing the requested dashboard
type ServicesGetDashboardBySlugResponse struct {
	AuthorId          *string                  `json:"authorId,omitempty"`
...
// V1ActiveTimeframe defines model for v1ActiveTimeframe.
type V1ActiveTimeframe struct {
	// EndTime Timeframe end time: The point in the time(date-time) when the rule will finish to be active.
	EndTime *string `json:"endTime,omitempty"`

	// StartTime Timeframe start time: The point in the time(date-time) when the rule will start to be active.
	StartTime *string `json:"startTime,omitempty"`

	// Timezone Timeframe timezone: The rule will be active according to a specific timezone.
...
// V1AlertSchedulerRule defines model for v1AlertSchedulerRule.
type V1AlertSchedulerRule struct {
	// CreatedAt Rule created_at: The date-time when the rule was created.
	CreatedAt *string `json:"createdAt,omitempty"`

	// Description Rule description.
	Description *string `json:"description,omitempty"`

	// Enabled Rule enabled: The rule activation mode.
	Enabled *bool                                       `json:"enabled,omitempty"`
	Filter  *AlertingalertSchedulerRuleProtobufv1Filter `json:"filter,omitempty"`

	// Id Rule id: The rule version id.
	Id *string `json:"id,omitempty"`

	// MetaLabels Rule meta_labels: Rule tags over the system.
	MetaLabels *[]AlertingmetaLabelsProtobufv1MetaLabel `json:"metaLabels,omitempty"`

	// Name Rule name.
	Name     *string     `json:"name,omitempty"`
	Schedule *V1Schedule `json:"schedule,omitempty"`

	// UniqueIdentifier Rule unique_identifier: The rule id.
	UniqueIdentifier *string `json:"uniqueIdentifier,omitempty"`

	// UpdatedAt Rule updated_at: The date-time when the rule was updated.
	UpdatedAt *string `json:"updatedAt,omitempty"`
}

// V1AlertSchedulerRuleWithActiveTimeframe defines model for v1AlertSchedulerRuleWithActiveTimeframe.
type V1AlertSchedulerRuleWithActiveTimeframe struct {
	AlertSchedulerRule   *V1AlertSchedulerRule `json:"alertSchedulerRule,omitempty"`
	NextActiveTimeframes *[]V1ActiveTimeframe  `json:"nextActiveTimeframes,omitempty"`
}

// V1AlertUniqueIds defines model for v1AlertUniqueIds.
type V1AlertUniqueIds struct {
	Value *[]string `json:"value,omitempty"`
}
...
type V1BatchGetPresetsResponse struct {
	NotFoundIds *[]string            `json:"notFoundIds,omitempty"`
	Presets     *map[string]V1Preset `json:"presets,omitempty"`
}
...
// V1CreateAlertSchedulerRuleRequest This is a request sent to create an alert scheduler rule
type V1CreateAlertSchedulerRuleRequest struct {
	AlertSchedulerRule V1AlertSchedulerRule `json:"alertSchedulerRule"`
}

// V1CreateAlertSchedulerRuleResponse This is a response sent after creating an alert scheduler rule
type V1CreateAlertSchedulerRuleResponse struct {
	AlertSchedulerRule V1AlertSchedulerRule `json:"alertSchedulerRule"`
}

// V1CreateBulkAlertSchedulerRuleRequest This is a request sent to create multiple alert scheduler rules
type V1CreateBulkAlertSchedulerRuleRequest struct {
	CreateAlertSchedulerRuleRequests []V1CreateAlertSchedulerRuleRequest `json:"createAlertSchedulerRuleRequests"`
}

// V1CreateBulkAlertSchedulerRuleResponse This is a response sent after creating multiple alert scheduler rules
type V1CreateBulkAlertSchedulerRuleResponse struct {
	CreateSuppressionResponses []V1CreateAlertSchedulerRuleResponse `json:"createSuppressionResponses"`
}
...
type V1CreateCustomPresetResponse struct {
	...
	Preset *V1Preset `json:"preset,omitempty"`
}
...
// V1Daily defines model for v1Daily.
type V1Daily = map[string]interface{}

// V1DeleteAlertSchedulerRuleResponse defines model for v1DeleteAlertSchedulerRuleResponse.
type V1DeleteAlertSchedulerRuleResponse = map[string]interface{}
...
// V1DurationFrequency defines model for v1DurationFrequency.
type V1DurationFrequency string
...
// V1GetAlertSchedulerRuleResponse This is a response sent to get an alert scheduler rule
type V1GetAlertSchedulerRuleResponse struct {
	AlertSchedulerRule V1AlertSchedulerRule `json:"alertSchedulerRule"`
}
...
// V1GetBulkAlertSchedulerRuleResponse This is a response sent after getting multiple alert scheduler rules
type V1GetBulkAlertSchedulerRuleResponse struct {
	AlertSchedulerRules []V1AlertSchedulerRuleWithActiveTimeframe `json:"alertSchedulerRules"`
	NextPageToken       *string                                   `json:"nextPageToken,omitempty"`
}
...
type V1GlobalRouter struct {
	...
	EvaluationMode *V1RouterEvaluationMode                   `json:"evaluationMode,omitempty"`
...
// V1IntegrationRevisionSingleNumericValue defines model for v1IntegrationRevisionSingleNumericValue.
type V1IntegrationRevisionSingleNumericValue struct {
...
// V1MetaLabels defines model for v1MetaLabels.
type V1MetaLabels struct {
	Value *[]AlertingmetaLabelsProtobufv1MetaLabel `json:"value,omitempty"`
}
...
// V1Monthly defines model for v1Monthly.
type V1Monthly struct {
	// DaysOfMonth Dynamic Monthly days_of_month: The rule will be activated at monthly intervals on specific days in a month.
...
// V1OneTime defines model for v1OneTime.
type V1OneTime struct {
	Timeframe *V1Timeframe `json:"timeframe,omitempty"`
}
...
// V1Preset Set of preconfigured templates for notification content rendering
...
// V1Recurring defines model for v1Recurring.
type V1Recurring struct {
	Always  *RecurringAlways    `json:"always,omitempty"`
	Dynamic *V1RecurringDynamic `json:"dynamic,omitempty"`
}

// V1RecurringDynamic defines model for v1RecurringDynamic.
type V1RecurringDynamic struct {
	Daily   *V1Daily   `json:"daily,omitempty"`
	Monthly *V1Monthly `json:"monthly,omitempty"`

	// RepeatEvery Recurring Dynamic repeat_every: The rule will be activated in a recurring mode according to the interval.
	RepeatEvery *int32 `json:"repeatEvery,omitempty"`

	// TerminationDate Recurring Dynamic termination_date: The rule will be terminated according to termination_date.
	TerminationDate *string      `json:"terminationDate,omitempty"`
	Timeframe       *V1Timeframe `json:"timeframe,omitempty"`
	Weekly          *V1Weekly    `json:"weekly,omitempty"`
}
...
// V1RouterEvaluationMode defines model for v1RouterEvaluationMode.
type V1RouterEvaluationMode string
...
// V1Schedule defines model for v1Schedule.
type V1Schedule struct {
	OneTime           *V1OneTime           `json:"oneTime,omitempty"`
	Recurring         *V1Recurring         `json:"recurring,omitempty"`
	ScheduleOperation *V1ScheduleOperation `json:"scheduleOperation,omitempty"`
}

// V1ScheduleOperation defines model for v1ScheduleOperation.
type V1ScheduleOperation string
...
// V1Timeframe defines model for v1Timeframe.
type V1Timeframe struct {
	Duration *AlertSchedulerRuleProtobufv1Duration `json:"duration,omitempty"`
...
// V1UpdateAlertSchedulerRuleRequest This is a request sent to update an alert scheduler rule
type V1UpdateAlertSchedulerRuleRequest struct {
	AlertSchedulerRule V1AlertSchedulerRule `json:"alertSchedulerRule"`
}

// V1UpdateAlertSchedulerRuleResponse This is a response sent after creating an alert scheduler rule
type V1UpdateAlertSchedulerRuleResponse struct {
	AlertSchedulerRule V1AlertSchedulerRule `json:"alertSchedulerRule"`
}

// V1UpdateBulkAlertSchedulerRuleRequest This is a request sent to update multiple alert scheduler rules
type V1UpdateBulkAlertSchedulerRuleRequest struct {
	UpdateAlertSchedulerRuleRequests []V1UpdateAlertSchedulerRuleRequest `json:"updateAlertSchedulerRuleRequests"`
}

// V1UpdateBulkAlertSchedulerRuleResponse This is a response sent after updating multiple alert scheduler rules
type V1UpdateBulkAlertSchedulerRuleResponse struct {
	UpdateSuppressionResponses []V1UpdateAlertSchedulerRuleResponse `json:"updateSuppressionResponses"`
}
...
// V1Weekly defines model for v1Weekly.
type V1Weekly struct {
	// DaysOfWeek Dynamic Weekly days_of_week: The rule will be activated at weekly intervals on specific days in a week.
...
type V3AlertDef struct {
	...
	// LastTriggeredTime The last time the alert definition was triggered
...
type V3MultipleValues struct {
	Matcher *Coralogixapiseventsv3FilterMatcher `json:"matcher,omitempty"`
	Values  *[]string                           `json:"values,omitempty"`
}
...
// VariablesConstant defines model for variablesConstant.
type VariablesConstant struct {
	Value *string `json:"value,omitempty"`
}

// VariablesMultiSelect defines model for variablesMultiSelect.
type VariablesMultiSelect struct {
	Selected             *[]string                            `json:"selected,omitempty"`
	Selection            *VariablesMultiSelectSelection       `json:"selection,omitempty"`
	SelectionOptions     *MultiSelectVariableSelectionOptions `json:"selectionOptions,omitempty"`
	Source               *VariablesMultiSelectSource          `json:"source,omitempty"`
	ValuesOrderDirection *CommonOrderDirection                `json:"valuesOrderDirection,omitempty"`
}

// VariablesMultiSelectQuery defines model for variablesMultiSelectQuery.
type VariablesMultiSelectQuery struct {
...
// VariablesMultiSelectQuerySource defines model for variablesMultiSelectQuerySource.
type VariablesMultiSelectQuerySource struct {
	Query               *VariablesMultiSelectQuery               `json:"query,omitempty"`
	RefreshStrategy     *VariablesMultiSelectRefreshStrategy     `json:"refreshStrategy,omitempty"`
	ValueDisplayOptions *VariablesMultiSelectValueDisplayOptions `json:"valueDisplayOptions,omitempty"`
}

// VariablesMultiSelectRefreshStrategy defines model for variablesMultiSelectRefreshStrategy.
type VariablesMultiSelectRefreshStrategy string

// VariablesMultiSelectSelection defines model for variablesMultiSelectSelection.
type VariablesMultiSelectSelection struct {
	All  *VariablesMultiSelectSelectionAllSelection  `json:"all,omitempty"`
	List *VariablesMultiSelectSelectionListSelection `json:"list,omitempty"`
}

// VariablesMultiSelectSelectionAllSelection defines model for variablesMultiSelectSelectionAllSelection.
type VariablesMultiSelectSelectionAllSelection = map[string]interface{}

// VariablesMultiSelectSelectionListSelection defines model for variablesMultiSelectSelectionListSelection.
type VariablesMultiSelectSelectionListSelection struct {
	Labels *[]string `json:"labels,omitempty"`
	Values *[]string `json:"values,omitempty"`
}

// VariablesMultiSelectSource defines model for variablesMultiSelectSource.
type VariablesMultiSelectSource struct {
	...
	Query        *VariablesMultiSelectQuerySource `json:"query,omitempty"`
	SpanField    *MultiSelectSpanFieldSource      `json:"spanField,omitempty"`
}

// VariablesMultiSelectValueDisplayOptions defines model for variablesMultiSelectValueDisplayOptions.
type VariablesMultiSelectValueDisplayOptions struct {
	LabelRegex *string `json:"labelRegex,omitempty"`
	ValueRegex *string `json:"valueRegex,omitempty"`
}

// VariablesVariable defines model for variablesVariable.
type VariablesVariable struct {
	Definition  *VariablesVariableDefinition  `json:"definition,omitempty"`
	Description *string                       `json:"description,omitempty"`
	DisplayName *string                       `json:"displayName,omitempty"`
	DisplayType *VariablesVariableDisplayType `json:"displayType,omitempty"`
	Name        *string                       `json:"name,omitempty"`
}

// VariablesVariableDefinition defines model for variablesVariableDefinition.
type VariablesVariableDefinition struct {
	Constant    *VariablesConstant    `json:"constant,omitempty"`
	MultiSelect *VariablesMultiSelect `json:"multiSelect,omitempty"`
}

// VariablesVariableDisplayType defines model for variablesVariableDisplayType.
type VariablesVariableDisplayType string

// VariablesV2VariableDisplayTypeV2 defines model for variables_v2VariableDisplayTypeV2.
type VariablesV2VariableDisplayTypeV2 string

// VariablesV2VariableSourceV2 defines model for variables_v2VariableSourceV2.
type VariablesV2VariableSourceV2 struct {
	Query   *VariablesV2VariableSourceV2QuerySource `json:"query,omitempty"`
	Static  *VariableSourceV2StaticSource           `json:"static,omitempty"`
	Textbox *VariableSourceV2TextBoxSource          `json:"textbox,omitempty"`
}

// VariablesV2VariableSourceV2QuerySource defines model for variables_v2VariableSourceV2QuerySource.
type VariablesV2VariableSourceV2QuerySource struct {
	AllOption            *VariableSourceV2AllOption                      `json:"allOption,omitempty"`
	LogsQuery            *VariableSourceV2QuerySourceLogsQuery           `json:"logsQuery,omitempty"`
	MetricsQuery         *VariableSourceV2QuerySourceMetricsQuery        `json:"metricsQuery,omitempty"`
	RefreshStrategy      *VariablesV2VariableSourceV2RefreshStrategy     `json:"refreshStrategy,omitempty"`
	SpansQuery           *VariableSourceV2QuerySourceSpansQuery          `json:"spansQuery,omitempty"`
	ValueDisplayOptions  *VariablesV2VariableSourceV2ValueDisplayOptions `json:"valueDisplayOptions,omitempty"`
	ValuesOrderDirection *CommonOrderDirection                           `json:"valuesOrderDirection,omitempty"`
}

// VariablesV2VariableSourceV2RefreshStrategy defines model for variables_v2VariableSourceV2RefreshStrategy.
type VariablesV2VariableSourceV2RefreshStrategy string

// VariablesV2VariableSourceV2ValueDisplayOptions defines model for variables_v2VariableSourceV2ValueDisplayOptions.
type VariablesV2VariableSourceV2ValueDisplayOptions struct {
	LabelRegex *string `json:"labelRegex,omitempty"`
	ValueRegex *string `json:"valueRegex,omitempty"`
}

// VariablesV2VariableV2 defines model for variables_v2VariableV2.
type VariablesV2VariableV2 struct {
	Description    *string                           `json:"description,omitempty"`
	DisplayFullRow *bool                             `json:"displayFullRow,omitempty"`
	DisplayName    *string                           `json:"displayName,omitempty"`
	DisplayType    *VariablesV2VariableDisplayTypeV2 `json:"displayType,omitempty"`
	Name           *string                           `json:"name,omitempty"`
	Source         *VariablesV2VariableSourceV2      `json:"source,omitempty"`
	Value          *VariablesV2VariableValueV2       `json:"value,omitempty"`
}

// VariablesV2VariableValueV2 defines model for variables_v2VariableValueV2.
type VariablesV2VariableValueV2 struct {
	Lucene        *VariableValueV2LuceneQueryValue              `json:"lucene,omitempty"`
	MultiString   *VariableValueV2MultiStringValue              `json:"multiString,omitempty"`
	Regex         *VariableValueV2RegexValue                    `json:"regex,omitempty"`
	SingleNumeric *VariablesV2VariableValueV2SingleNumericValue `json:"singleNumeric,omitempty"`
	SingleString  *VariableValueV2SingleStringValue             `json:"singleString,omitempty"`
}

// VariablesV2VariableValueV2SingleNumericValue defines model for variables_v2VariableValueV2SingleNumericValue.
type VariablesV2VariableValueV2SingleNumericValue struct {
	Label *string  `json:"label,omitempty"`
	Value *float32 `json:"value,omitempty"`
}
...
type WidgetsBarChartDataprimeQuery struct {
	...
	Filters *[]FiltersFilterSource `json:"filters,omitempty"`
...
// WidgetsDynamicQuery defines model for widgetsDynamicQuery.
type WidgetsDynamicQuery struct {
	// Dataprime A Dataprime variant of the query
	Dataprime *QueryDataprime `json:"dataprime,omitempty"`

	// Logs A logs variant of the query
	Logs *QueryLogs `json:"logs,omitempty"`

	// Metrics A metrics variant of the query
	Metrics *QueryMetrics `json:"metrics,omitempty"`

	// Spans A spans variant of the query
	Spans *QuerySpans `json:"spans,omitempty"`
}
...
// AlertSchedulerRuleServiceGetBulkAlertSchedulerRuleParams defines parameters for AlertSchedulerRuleServiceGetBulkAlertSchedulerRule.
type AlertSchedulerRuleServiceGetBulkAlertSchedulerRuleParams struct {
	// ActiveTimeframeStartTime Timeframe start time: The point in the time(date-time) when the rule will start to be active.
	ActiveTimeframeStartTime *string `form:"activeTimeframe.startTime,omitempty" json:"activeTimeframe.startTime,omitempty"`

	// ActiveTimeframeEndTime Timeframe end time: The point in the time(date-time) when the rule will finish to be active.
	ActiveTimeframeEndTime *string `form:"activeTimeframe.endTime,omitempty" json:"activeTimeframe.endTime,omitempty"`

	// ActiveTimeframeTimezone Timeframe timezone: The rule will be active according to a specific timezone.
	ActiveTimeframeTimezone                                                    *string   `form:"activeTimeframe.timezone,omitempty" json:"activeTimeframe.timezone,omitempty"`
	Enabled                                                                    *bool     `form:"enabled,omitempty" json:"enabled,omitempty"`
	AlertSchedulerRulesIdsAlertSchedulerIdsAlertSchedulerRuleIds               *[]string `form:"alertSchedulerRulesIds.alertSchedulerIds.alertSchedulerRuleIds,omitempty" json:"alertSchedulerRulesIds.alertSchedulerIds.alertSchedulerRuleIds,omitempty"`
	AlertSchedulerRulesIdsAlertSchedulerVersionIdsAlertSchedulerRuleVersionIds *[]string `form:"alertSchedulerRulesIds.alertSchedulerVersionIds.alertSchedulerRuleVersionIds,omitempty" json:"alertSchedulerRulesIds.alertSchedulerVersionIds.alertSchedulerRuleVersionIds,omitempty"`
...
// AlertDefsServiceListAlertDefsParams defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParams struct {
	// QueryFilterNameFilterName The name(s) of the alert definition - multiple values are OR'd together
	QueryFilterNameFilterName []string `form:"queryFilter.nameFilter.name" json:"queryFilter.nameFilter.name"`

	// QueryFilterNameFilterMatcher The filter operator (EQUALS, NOT_EQUALS, CONTAINS)
	QueryFilterNameFilterMatcher AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher `form:"queryFilter.nameFilter.matcher" json:"queryFilter.nameFilter.matcher"`

	// QueryFilterTypeFilterType The alert type(s) - multiple values are OR'd together
	QueryFilterTypeFilterType []AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType `form:"queryFilter.typeFilter.type" json:"queryFilter.typeFilter.type"`

	// QueryFilterTypeFilterMatcher The filter operator (EQUALS, NOT_EQUALS)
	QueryFilterTypeFilterMatcher AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher `form:"queryFilter.typeFilter.matcher" json:"queryFilter.typeFilter.matcher"`

	// QueryFilterEntityLabelsFilterEntityLabels The entity label key-value pairs to filter by
	QueryFilterEntityLabelsFilterEntityLabels *string `form:"queryFilter.entityLabelsFilter.entityLabels,omitempty" json:"queryFilter.entityLabelsFilter.entityLabels,omitempty"`

	// QueryFilterEntityLabelsFilterValuesOperator Whether all labels must match (AND) or any label can match (OR)
	QueryFilterEntityLabelsFilterValuesOperator AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator `form:"queryFilter.entityLabelsFilter.valuesOperator" json:"queryFilter.entityLabelsFilter.valuesOperator"`

	// QueryFilterPriorityFilterPriority The priority(ies) of the alert definition - multiple values are OR'd together
	QueryFilterPriorityFilterPriority []AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority `form:"queryFilter.priorityFilter.priority" json:"queryFilter.priorityFilter.priority"`

	// QueryFilterPriorityFilterMatcher The filter operator (EQUALS, NOT_EQUALS)
	QueryFilterPriorityFilterMatcher AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher `form:"queryFilter.priorityFilter.matcher" json:"queryFilter.priorityFilter.matcher"`

	// QueryFilterEnabledFilterEnabled Whether to filter for enabled (true) or disabled (false) alerts
	QueryFilterEnabledFilterEnabled bool `form:"queryFilter.enabledFilter.enabled" json:"queryFilter.enabledFilter.enabled"`

	// QueryFilterModifiedTimeRangeFilterModifiedAtRangeStartTime Start time of the range
	QueryFilterModifiedTimeRangeFilterModifiedAtRangeStartTime time.Time `form:"queryFilter.modifiedTimeRangeFilter.modifiedAtRange.startTime" json:"queryFilter.modifiedTimeRangeFilter.modifiedAtRange.startTime"`

	// QueryFilterModifiedTimeRangeFilterModifiedAtRangeEndTime End time of the range
	QueryFilterModifiedTimeRangeFilterModifiedAtRangeEndTime time.Time `form:"queryFilter.modifiedTimeRangeFilter.modifiedAtRange.endTime" json:"queryFilter.modifiedTimeRangeFilter.modifiedAtRange.endTime"`

	// QueryFilterLastTriggeredTimeRangeFilterLastTriggeredAtRangeStartTime Start time of the range
	QueryFilterLastTriggeredTimeRangeFilterLastTriggeredAtRangeStartTime time.Time `form:"queryFilter.lastTriggeredTimeRangeFilter.lastTriggeredAtRange.startTime" json:"queryFilter.lastTriggeredTimeRangeFilter.lastTriggeredAtRange.startTime"`

	// QueryFilterLastTriggeredTimeRangeFilterLastTriggeredAtRangeEndTime End time of the range
	QueryFilterLastTriggeredTimeRangeFilterLastTriggeredAtRangeEndTime time.Time `form:"queryFilter.lastTriggeredTimeRangeFilter.lastTriggeredAtRange.endTime" json:"queryFilter.lastTriggeredTimeRangeFilter.lastTriggeredAtRange.endTime"`

	// QueryFilterTypeSpecificFilterSloFilterSloId The SLO ID(s) to filter by - multiple values are OR'd together
	QueryFilterTypeSpecificFilterSloFilterSloId []string `form:"queryFilter.typeSpecificFilter.sloFilter.sloId" json:"queryFilter.typeSpecificFilter.sloFilter.sloId"`

	// QueryFilterTypeSpecificFilterSloFilterMatcher The filter operator (EQUALS, NOT_EQUALS)
	QueryFilterTypeSpecificFilterSloFilterMatcher AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher `form:"queryFilter.typeSpecificFilter.sloFilter.matcher" json:"queryFilter.typeSpecificFilter.sloFilter.matcher"`
...
// AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterNameFilterMatcher string

// AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterType string

// AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterTypeFilterMatcher string

// AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterEntityLabelsFilterValuesOperator string

// AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterPriority string

// AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterPriorityFilterMatcher string

// AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher defines parameters for AlertDefsServiceListAlertDefs.
type AlertDefsServiceListAlertDefsParamsQueryFilterTypeSpecificFilterSloFilterMatcher string
...
// AlertSchedulerRuleServiceCreateAlertSchedulerRuleJSONRequestBody defines body for AlertSchedulerRuleServiceCreateAlertSchedulerRule for application/json ContentType.
type AlertSchedulerRuleServiceCreateAlertSchedulerRuleJSONRequestBody = V1CreateAlertSchedulerRuleRequest

// AlertSchedulerRuleServiceUpdateAlertSchedulerRuleJSONRequestBody defines body for AlertSchedulerRuleServiceUpdateAlertSchedulerRule for application/json ContentType.
type AlertSchedulerRuleServiceUpdateAlertSchedulerRuleJSONRequestBody = V1UpdateAlertSchedulerRuleRequest

// AlertSchedulerRuleServiceCreateBulkAlertSchedulerRuleJSONRequestBody defines body for AlertSchedulerRuleServiceCreateBulkAlertSchedulerRule for application/json ContentType.
type AlertSchedulerRuleServiceCreateBulkAlertSchedulerRuleJSONRequestBody = V1CreateBulkAlertSchedulerRuleRequest

// AlertSchedulerRuleServiceUpdateBulkAlertSchedulerRuleJSONRequestBody defines body for AlertSchedulerRuleServiceUpdateBulkAlertSchedulerRule for application/json ContentType.
type AlertSchedulerRuleServiceUpdateBulkAlertSchedulerRuleJSONRequestBody = V1UpdateBulkAlertSchedulerRuleRequest
...
type PresetsServiceCreateCustomPresetJSONRequestBody = V1Preset
...
type PresetsServiceReplaceCustomPresetJSONRequestBody = V1Preset
